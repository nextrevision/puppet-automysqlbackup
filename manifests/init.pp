...
# I have kept the same variable names as the author of the script
# to make it easier to lookup the documentation. Essentially, add
# CONFIG_ to the variable in question and regex search the
# documentation to find the meaning. No interpretation from me.
#
